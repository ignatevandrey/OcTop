                ...
                <div class="modal__inner modal__innerStarted">
                    <div class="mod-request__content">
                        ...
                        <div class="request__fields">
                            ...
                            <input class="request__input request__inputStarted request__input-name" type="text" placeholder="Имя">
                            </label>
                            <label class="request__field request__field-phone">
                            <input class="request__input request__inputStarted request__input-phone" type="tel" name="phone"  placeholder="Номер ">
                            </label>
