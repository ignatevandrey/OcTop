<section class="comfort__wrap">
    <div class="container">
    <h2 class="title">С нами комфортно работать</h2>
        <div class="comfort">
                <div class="comfort__item">
                    ...
                    <div class="comfort__card">
                        ...
                        <div class="comfort_textWrap">
                            ...
                            <h3 class="sup-title">
                                А вдруг что-то сломается в нерабочее время?
                            </h3>
                            </div>
                            <p class="comfort__suptitle">
                                Мы дадим вам бесплатный пробный период на 30 дней!
                ...
                <div class="comfort__item">
                   <div class="comfort__card">
                        ...
                        <div class="comfort_textWrap">
                            ...
                            <h3 class="sup-title">
                                Пугают новые сложные технологии??
                            </h3>
                            </div>
                            <p class="comfort__suptitle">
                                Мы дадим вам бесплатный пробный период на 30 дней!
                   ...
                   <div class="comfort__card">
                        ...
                        <div class="comfort_textWrap">
                            ...
                            <h3 class="sup-title">
                                Что будет происходить при обновлениях 1С?
                            </h3>
                            </div>
                            <p class="comfort__suptitle">
                                Мы дадим вам бесплатный пробный период на 30 дней!
