    ...
    <div class="header__top">
        <div class="container">
            <div class="header__wrap">
                <div class="header__place section-text"><b>Краснодар</b>, ул. Бассейная, 25</div>
                <button class="btn btn-default btn-main1-main1" type="button">
            ...
            <div class="header__wrap">
                <a href="/" class="logo header-logo">
                    <picture class="about__item-img">
                        ...
                        <img class="image" src="/img/images/logo-header.png" width="115" height="43" alt="Логотип TEMPLATE" />
                    </picture>
                </a>
