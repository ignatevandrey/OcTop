    ...
    <div class="container">
        <div class="footer__content">
            <div class="footer__item footer__item-contact">
                ...
                <button data-modal="request" class="btn btn-default" data-h="Оставьте заявку и наш специалист перезвонит Вам" type="button">
                    <span class="btn__form">Перезвоните мне</span>
                </button>
            </div>
